...
2. RSS 全件を取得
3. KV に保存した前回最新記事の link と RSS を比較
4. 前回最新記事より新しい item のみ Misskey へ投稿
5. 投稿成功ごとに最新処理済み link を更新
...
- 初回起動時はバックログを一括投稿せず、その時点の最新記事を基準として記録します。
